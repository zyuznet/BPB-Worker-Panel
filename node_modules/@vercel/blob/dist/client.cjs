...
function createPutExtraChecks(methodName) {
  return function extraChecks(options) {
    if (!options.token.startsWith("vercel_blob_client_")) {
      throw new (0, _chunkKWR42HXHcjs.BlobError)(`${methodName} must be called with a client token`);
    }
    if (
...
var upload = _chunkKWR42HXHcjs.createPutMethod.call(void 0, {
  allowedOptions: ["contentType"],
  extraChecks(options) {
...
var uploadPresigned = _chunkKWR42HXHcjs.createPutMethod.call(void 0, {
  allowedOptions: ["contentType"],
  extraChecks(options) {
    if (options.handleUploadUrl === void 0) {
      throw new (0, _chunkKWR42HXHcjs.BlobError)(
...
async function handleUpload({
  ...
  var _a, _b, _c, _d;
  const resolvedToken = _chunkKWR42HXHcjs.getReadWriteBlobTokenFromOptionsOrEnv.call(void 0, { token });
  ...
  switch (type) {
    ...
    case "blob.upload-completed": {
      ...
      if (!signature) {
        throw new (0, _chunkKWR42HXHcjs.BlobError)("Missing callback signature");
      }
      ...
      if (!isVerified) {
        throw new (0, _chunkKWR42HXHcjs.BlobError)("Invalid callback signature");
      }
    ...
    default:
      throw new (0, _chunkKWR42HXHcjs.BlobError)("Invalid event type");
  }
}
async function handleUploadPresigned({
  ...
  if (!resolvedWebhookPublicKey) {
    throw new (0, _chunkKWR42HXHcjs.BlobError)("Missing webhook public key");
  }
  const type = body.type;
  switch (type) {
    case "blob.generate-presigned-url": {
      ...
      const presignedUrlPayload = await _chunkKWR42HXHcjs.presign.call(void 0, token, {
...
async function retrieveClientToken(options) {
  ...
  if (!res.ok) {
    throw new (0, _chunkKWR42HXHcjs.BlobError)("Failed to  retrieve the client token");
  }
  try {
...
async function retrievePresignedUrlPayload(options) {
  ...
  if (!res.ok) {
    throw new (0, _chunkKWR42HXHcjs.BlobError)("Failed to retrieve the presigned URL");
  }
  try {
    ...
    throw new (0, _chunkKWR42HXHcjs.BlobError)("Missing presignedUrlPayload");
  } catch (error) {
    if (error instanceof _chunkKWR42HXHcjs.BlobError) {
      throw error;
    }
    throw new (0, _chunkKWR42HXHcjs.BlobError)("Failed to retrieve the presigned URL");
  }
...
async function generateClientTokenFromReadWriteToken({
  ...
  const readWriteToken = _chunkKWR42HXHcjs.getReadWriteBlobTokenFromOptionsOrEnv.call(void 0, { token });
  const storeId = _chunkKWR42HXHcjs.parseStoreIdFromReadWriteToken.call(void 0, readWriteToken) || null;
  if (!storeId) {
    throw new (0, _chunkKWR42HXHcjs.BlobError)(
  ...
  if (!securedKey) {
    throw new (0, _chunkKWR42HXHcjs.BlobError)("Unable to sign client token");
  }
