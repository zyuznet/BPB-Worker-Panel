...
function parsePhoneNumber(formattedPhoneNumber, defaultCountry, defaultCallingCode, metadata) {
  ...
  let {
    ...
    countryCallingCode,
    number
  } = extractCountryCallingCode(parseIncompletePhoneNumber(formattedPhoneNumber), undefined, defaultCountry, defaultCallingCode, metadata.metadata);
  ...
  const {
    nationalNumber,
    carrierCode
  } = extractNationalNumber(parseIncompletePhoneNumber(number), country, metadata);
